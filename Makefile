...
SRCS = src/main.c src/sdl.c src/utils.c src/structs.c src/game/map.c src/game/player.c src/game/game.c src/game/interact.c src/game/objects.c src/text.c
