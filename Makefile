...
SRCS = src/main.c src/game/init.c src/utils.c src/structs.c src/game/map.c src/game/player.c src/game/game.c src/game/interact.c src/game/rendertext.c src/game/blur.c
